...
function App() {
  ...
  const askQues = async () => {
    ...
    const questionText = ques || selectedHistory;
  ...
  return (
    <div className="grid grid-cols-5 h-screen text-center">
      <div className="col-span-1 bg-zinc-700 h-screen overflow-scroll">
      ...
      <div className="col-span-4 bg-zinc-800 flex flex-col justify-center items-center gap-6 h-screen">
        ...
        {result.length > 0 ? (
          <div className="container h-2/3 text-white overflow-scroll px-32" ref={scrollRef}>
            <ul>
